...
- Append `cmake` to diagnostics that this extension contributes to the Problems Pane. [PR [#4766](https://github.com/microsoft/vscode-cmake-tools/issues/4766)](https://github.com/microsoft/vscode-cmake-tools/pull/4766)
...
- Fix diagnostics to handle when there isn't a command in the error output. [PR [#4765](https://github.com/microsoft/vscode-cmake-tools/issues/4765)](https://github.com/microsoft/vscode-cmake-tools/pull/4765)
...
- Add output parser for [include-what-you-use](https://github.com/include-what-you-use). [PR [#4548](https://github.com/microsoft/vscode-cmake-tools/issues/4548)](https://github.com/microsoft/vscode-cmake-tools/pull/4548) [@malsyned](https://github.com/malsyned)
- Add better return information in the API. [PR [#4518](https://github.com/microsoft/vscode-cmake-tools/issues/4518)](https://github.com/microsoft/vscode-cmake-tools/pull/4518)
...
- Remove the demangling feature in the code coverage implementation for now since it doesn't work properly. [PR [#4658](https://github.com/microsoft/vscode-cmake-tools/issues/4658)](https://github.com/microsoft/vscode-cmake-tools/pull/4658)
...
- Fix bug that makes `Configure Task` lists only first folder in workspace. [#3232](https://github.com/microsoft/vscode-cmake-tools/blob/HEAD/https/github.com/microsoft/vscode-cmake-tools/issues/3232)
...
- Add basic CMake language services: quick hover and completions for CMake built-ins. [PR [#4204](https://github.com/microsoft/vscode-cmake-tools/issues/4204)](https://github.com/microsoft/vscode-cmake-tools/pull/4204)
