...
<ol>
<li><p data-loc-id="walkthrough.windows.text2">MSVC'yi yüklemek için VS Code terminalini (CTRL + `) açın ve aşağıdaki komutu yapıştırın:</p>
...
<ol>
<li><p data-loc-id="walkthrough.windows.open.command.prompt">Windows Başlat menüsünde <code>developer</code> yazarak <strong>Developer Command Prompt for VS</strong>'i açın.</p>
</li>
