...
<ol>
<li><p data-loc-id="walkthrough.windows.text2">若要安装 MSVC，请打开 VS Code 终端(CTRL + `)并在以下命令中粘贴:</p>
...
<ol>
<li><p data-loc-id="walkthrough.windows.open.command.prompt">通过在 Windows“开始”菜单中键入 <code>developer</code> 来打开 <strong>Developer Command Prompt for VS</strong>。</p>
</li>
