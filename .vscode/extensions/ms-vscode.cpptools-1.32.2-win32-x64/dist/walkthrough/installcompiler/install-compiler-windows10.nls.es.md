...
<ol>
<li><p data-loc-id="walkthrough.windows.text2">Para instalar MSVC, abra el terminal de VS Code (CTRL + `) y pegue el siguiente comando:</p>
...
<ol>
<li><p data-loc-id="walkthrough.windows.open.command.prompt">Abra el <strong>Developer Command Prompt for VS</strong> escribiendo <code>developer</code> en el menú Inicio de Windows.</p>
</li>
