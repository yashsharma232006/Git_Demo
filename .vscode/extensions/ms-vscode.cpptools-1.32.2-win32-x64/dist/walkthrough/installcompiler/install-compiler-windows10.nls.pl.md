...
<ol>
<li><p data-loc-id="walkthrough.windows.text2">Aby zainstalować program MSVC, otwórz terminal VS Code (CTRL + `) i wklej następujące polecenie:</p>
...
<ol>
<li><p data-loc-id="walkthrough.windows.open.command.prompt">Otwórz <strong>Developer Command Prompt for VS</strong>, wpisując <code>developer</code> w menu Start systemu Windows.</p>
</li>
