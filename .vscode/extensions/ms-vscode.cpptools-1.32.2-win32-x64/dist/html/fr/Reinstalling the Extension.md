...
<p data-loc-id="reinstall.extension.text7">Réinstallez ensuite via l’interface utilisateur du Marketplace dans VS Code.</p>

<p data-loc-id="reinstall.extension.text8">Si la version correcte de l’extension ne peut pas être déployée par VS Code, le VSIX approprié pour votre système peut être <a href="https://marketplace.visualstudio.com/items?itemName=ms-vscode.cpptools" data-loc-id="download.vsix.link.title">téléchargé à partir du site web du Marketplace VS Code</a> et installé à l’aide de l’option 'Installer à partir de VSIX...' sous le menu '...' de l’interface utilisateur du Marketplace dans VS Code.</p>
</body></html>