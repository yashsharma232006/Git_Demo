...
* Add a `cpptools.waitForTagParsing` command (for use by the `C/C++ DevTools` extension). [PR [#14407](https://github.com/Microsoft/vscode-cpptools/issues/14407)](https://github.com/microsoft/vscode-cpptools/pull/14407/changes)
...
* Add support for `program` in attach debug configurations. [#14046](https://github.com/microsoft/vscode-cpptools/issues/14046)
  * Thanks for the contribution. [@Subham-KRLX (Subham)](https://github.com/Subham-KRLX) [PR [#14108](https://github.com/Microsoft/vscode-cpptools/issues/14108)](https://github.com/microsoft/vscode-cpptools/pull/14108)
...
* Fix `C_Cpp.commentContinuationPatterns` not working after the 2nd line (for non-`/**` patterns). [#8998](https://github.com/microsoft/vscode-cpptools/issues/8998)
  * Thanks for the contribution. [@dinhtam2c](https://github.com/dinhtam2c) [PR [#14074](https://github.com/Microsoft/vscode-cpptools/issues/14074)](https://github.com/microsoft/vscode-cpptools/pull/14074)
...
* Fix some invalid assumptions for cppbuild tasks. [PR [#13989](https://github.com/Microsoft/vscode-cpptools/issues/13989)](https://github.com/microsoft/vscode-cpptools/pull/13989)
...
* Improvements to GitHub Copilot activation. [PR [#13924](https://github.com/Microsoft/vscode-cpptools/issues/13924)](https://github.com/microsoft/vscode-cpptools/pull/13924)
...
* Fix the description of `debugServerPath`. [PR [#13778](https://github.com/Microsoft/vscode-cpptools/issues/13778)](https://github.com/microsoft/vscode-cpptools/pull/13778)
...
* Fix `pipeTransport.quoteArgs` not being handled correctly. [#13791](https://github.com/microsoft/vscode-cpptools/issues/13791)
  * Thanks for the contribution. [@mrjist (Matt)](https://github.com/mrjist) [PR [#13794](https://github.com/Microsoft/vscode-cpptools/issues/13794)](https://github.com/microsoft/vscode-cpptools/pull/13794)
...
* Fix "CMake Tools" translations. [PR [#13854](https://github.com/Microsoft/vscode-cpptools/issues/13854)](https://github.com/microsoft/vscode-cpptools/pull/13854)
...
* Fix extension activation getting stuck by GitHub Copilot activation. [#13914](https://github.com/microsoft/vscode-cpptools/issues/13914)
  * Thanks for the contribution. [@dbaeumer (Dirk Bäumer)](https://github.com/dbaeumer) [PR [#13918](https://github.com/Microsoft/vscode-cpptools/issues/13918)](https://github.com/microsoft/vscode-cpptools/pull/13918)

## Version 1.26.4: September 9, 2025
### Enhancement
* Update GitHub Copilot APIs. [PR [#13877](https://github.com/Microsoft/vscode-cpptools/issues/13877)](https://github.com/microsoft/vscode-cpptools/pull/13877)
  * Thanks for the contribution. [@dbaeumer (Dirk Bäumer)](https://github.com/dbaeumer)
...
* Minor debugger fixes. [PR [#13654](https://github.com/Microsoft/vscode-cpptools/issues/13654)](https://github.com/microsoft/vscode-cpptools/pull/13654), [PR [#13671](https://github.com/Microsoft/vscode-cpptools/issues/13671)](https://github.com/microsoft/vscode-cpptools/pull/13671)
...
* Improve the description of the `C_Cpp.copilotHover` setting. [PR [#13461](https://github.com/Microsoft/vscode-cpptools/issues/13461)](https://github.com/microsoft/vscode-cpptools/pull/13461)
...
* Fix the handling of default file associations for certain file extensions. [PR [#13455](https://github.com/Microsoft/vscode-cpptools/issues/13455)](https://github.com/microsoft/vscode-cpptools/pull/13455)
* Fix shell parsing of the arguments of a full command line in `compilerPath`. [PR [#13468](https://github.com/Microsoft/vscode-cpptools/issues/13468)](https://github.com/microsoft/vscode-cpptools/pull/13468)
...
* Stop automatically mapping a `.C` file to C++ if it's already set in `files.associations`. [PR [#13476](https://github.com/Microsoft/vscode-cpptools/issues/13476)](https://github.com/microsoft/vscode-cpptools/pull/13476)
* Fix issues with the `recursiveIncludes` properties in the configuration UI editor. [PR [#13498](https://github.com/Microsoft/vscode-cpptools/issues/13498)](https://github.com/microsoft/vscode-cpptools/pull/13498)
...
### New Feature
* Add support for Copilot descriptions in hover tooltips, controlled by the `C_Cpp.copilotHover` setting. [PR [#13385](https://github.com/Microsoft/vscode-cpptools/issues/13385)](https://github.com/microsoft/vscode-cpptools/pull/13385)

### Enhancements
* Improve/fix the switch header/source feature. [#2635](https://github.com/microsoft/vscode-cpptools/issues/2635)
* Add detected test frameworks to the Copilot context when `#cpp` is used. [PR [#13285](https://github.com/Microsoft/vscode-cpptools/issues/13285)](https://github.com/microsoft/vscode-cpptools/pull/13285)
* Update clang-tidy and clang-format from 19.1.7 to 20.1.2. [PR [#13348](https://github.com/Microsoft/vscode-cpptools/issues/13348)](https://github.com/microsoft/vscode-cpptools/pull/13348)
* Remove some unnecessary files from the vsix. [PR [#13368](https://github.com/Microsoft/vscode-cpptools/issues/13368)](https://github.com/microsoft/vscode-cpptools/pull/13368)
* Improve the logging when a non-existent path is used for indexing. [PR [#13372](https://github.com/Microsoft/vscode-cpptools/issues/13372)](https://github.com/microsoft/vscode-cpptools/pull/13372)
* Add a new `recursiveIncludes` property to `c_cpp_properties.json`. [PR [#13374](https://github.com/Microsoft/vscode-cpptools/issues/13374)](https://github.com/microsoft/vscode-cpptools/pull/13374)
* Remove the `C_Cpp.updateChannel` setting. [PR [#13376](https://github.com/Microsoft/vscode-cpptools/issues/13376)](https://github.com/microsoft/vscode-cpptools/pull/13376)
...
* Fix a potential race between didChange and didOpen. [PR [#13209](https://github.com/Microsoft/vscode-cpptools/issues/13209)](https://github.com/microsoft/vscode-cpptools/pull/13209)
* Fix an issue with the `.editorconfig` `tab_size`. [PR [#13216](https://github.com/Microsoft/vscode-cpptools/issues/13216)](https://github.com/microsoft/vscode-cpptools/pull/13216)
...
* Fix system include/framework paths being used as a fallback for user include/framework paths in the base configuration. [PR [#13247](https://github.com/Microsoft/vscode-cpptools/issues/13247)](https://github.com/microsoft/vscode-cpptools/pull/13247)
...
* Fix an issue with `C:` being treated as a relative path. [PR [#13297](https://github.com/Microsoft/vscode-cpptools/issues/13297)](https://github.com/microsoft/vscode-cpptools/pull/13297)
...
* Fix some localization bugs. [PR [#13373](https://github.com/Microsoft/vscode-cpptools/issues/13373)](https://github.com/microsoft/vscode-cpptools/pull/13373)
...
* Enable setting multiple compile commands. [#7029](https://github.com/microsoft/vscode-cpptools/issues/7029)
  * Thanks for the contribution. [@yiftahw](https://github.com/yiftahw) [PR [#12960](https://github.com/Microsoft/vscode-cpptools/issues/12960)](https://github.com/microsoft/vscode-cpptools/pull/12960)
...
* Fix `compile_commands.json` no longer being used if the containing folder is deleted and recreated. [#7030](https://github.com/microsoft/vscode-cpptools/issues/7030)
  * Thanks for the contribution. [@yiftahw](https://github.com/yiftahw) [PR [#13032](https://github.com/Microsoft/vscode-cpptools/issues/13032)](https://github.com/microsoft/vscode-cpptools/pull/13032)
...
* Fix a leak of compile command file watchers. [#12946](https://github.com/microsoft/vscode-cpptools/issues/12946)
  * Thanks for the contribution. [@yiftahw](https://github.com/yiftahw) [PR [#12948](https://github.com/Microsoft/vscode-cpptools/issues/12948)](https://github.com/microsoft/vscode-cpptools/pull/12948)
...
* Add `miDebuggerArgs` to debugger attach option.
  * Thanks for the contribution @Summon528 [PR [#11066](https://github.com/Microsoft/vscode-cpptools/issues/11066)](https://github.com/microsoft/vscode-cpptools/pull/11066)
...
* Use integratedTerminal when user is running cl.exe for debugger. [#11032](https://github.com/microsoft/vscode-cpptools/issues/11032)
  * Thanks for the contribution @caiohamamura [PR [#11035](https://github.com/Microsoft/vscode-cpptools/issues/11035)](https://github.com/microsoft/vscode-cpptools/pull/11035)
